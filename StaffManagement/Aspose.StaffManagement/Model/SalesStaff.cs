...
{
    /// <summary>
    /// Implements the Sales Staff model data
    /// 
    /// 2019/07/03 - created, VTyagunov
    /// </summary>
    public class SalesStaff : BaseStaff
    {
        /// <summary>
        /// All Subordinates of the sales staff
        /// </summary>
        ...
        public SalesStaff(int id, string name, DateTime joinDate, BaseStaff supervisor = null, 
